...
const info=[
  {
    icon: <FaPhoneAlt />,
    title: 'Phone',
    description:'(+91) 9182879781',
  },
  {
    icon: <FaEnvelope />,
    title: 'Email',
    description:'ravishankaradimula2004@gmail.com',
  },
  {
    icon: <FaMapMarkerAlt />,
    title: 'Address',
    description:'H.No:1-3 ,Thammada Palli, Banagana Palli,Nandyal,Andhra Pradesh.',
  },
];
         ...
         <div className="xl:h-[54%] order-2 xl:order-none">
          <form className="flex flex-col gap-6 p-10 bg-[#27272c]">
            ...
            <p className="text-white/60">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Odio minus nisi culpa accusamus. Asperiores quasi magni voluptas ea, tempora aspernatur!
            </p>
            ...
            {/* <Select>
              <SelectTrigger className="w-full">
                <SelectValue placeholder="Sel"></SelectValue>
              </SelectTrigger>
            </Select> */}
            <Textarea
             className="h-[200px]"
