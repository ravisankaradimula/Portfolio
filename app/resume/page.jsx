...
import{FaHtml5,FaCss3,FaJs,FaReact,FaNodeJs} from "react-icons/fa"
  ...
  const about={
    ...
    info: [
      {
        fieldName:"Name",
        fieldValue: "Ravi Shankar"
      },
      {
        fieldName:"Phone",
        fieldValue: "(+91) 9182879781"
      },
      {
      ...
      {
        fieldName:"Email",
        fieldValue: "ravishankaradimula2004@gmail.com"
      },
      {
        fieldName:"Languages",
  ...
  const education={
    ...
    items:[
      ...
      {
        institution:" APSWR Junior College,Chinna Tekur",
        degree:"Intermediate(MPC)",
        duration:"2020-2022",
      },
      {
        institution:"AP Residensial School,Kalva Bugga",
